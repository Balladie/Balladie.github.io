...
To make a quick and unbiased exploration, I chose NeuTTS model from Neuphonic as it is based on the simplest LM backbone architecture based on Qwen and LLaMA producing discrete codes.
