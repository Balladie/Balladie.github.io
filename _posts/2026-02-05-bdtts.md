...
I've noticed that naively supervising with real data degrades quality too much. Instead of this, we can intuitively combine AR-to-block annealed training with knowledge distillation (KD) to preserve and fully leverage from autoregressive teacher's capability. The typical objective for KD can be denoted as
...
<!-- | Baseline (AR) | Ours (Block, th=0.015) | Ours (Block, th=0.003) |
|---|---|---|
| 53.25 | 79.24 | 101.50 | -->
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include audio.liquid path="assets/audio/bdtts/prompt_audio_sad_1.wav" controls=true %}
        <div class="caption">
            Input audio 1
        </div>
    </div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include audio.liquid path="assets/audio/bdtts/output_air_audio_sad_1_0.wav" controls=true %}
        <div class="caption">
            AR output 1
        </div>
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include audio.liquid path="assets/audio/bdtts/output_air_audio_sad_1_1.wav" controls=true %}
        <div class="caption">
            AR output 2
        </div>
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include audio.liquid path="assets/audio/bdtts/output_bd_audio_sad_1_0.wav" controls=true %}
        <div class="caption">
            Block output 1
        </div>
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include audio.liquid path="assets/audio/bdtts/output_bd_audio_sad_1_1.wav" controls=true %}
        <div class="caption">
            Block output 2
        </div>
    </div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include audio.liquid path="assets/audio/bdtts/prompt_dave.wav" controls=true %}
        <div class="caption">
            Input audio 2
        </div>
    </div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include audio.liquid path="assets/audio/bdtts/output_air_0.wav" controls=true %}
        <div class="caption">
            AR output 1
        </div>
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include audio.liquid path="assets/audio/bdtts/output_air_1.wav" controls=true %}
        <div class="caption">
            AR output 2
        </div>
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include audio.liquid path="assets/audio/bdtts/output_bd_1.wav" controls=true %}
        <div class="caption">
            Block output 1
        </div>
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include audio.liquid path="assets/audio/bdtts/output_bd_0.wav" controls=true %}
        <div class="caption">
            Block output 2
        </div>
    </div>
...
This recipe can be applied to all models powered by LM backbone producing discrete tokens: adopting on more models would help them accelerate and observe more model-agnostic behaviors and problems.
...
It could also be challenged to more difficult scenarios such as low-step distillation. There are some recent works that explores in this perspective, so it can be good exploration on finding whether it would be beneficial in practice to further optimize.

Another exploration would be more on the low-level optimization, such as leveraging from flexible-mask kernels and more aggressive caching, pushing both the baseline and modified one to their best-optimized states, which would show true comparison on upper bound when applied in practice. 
